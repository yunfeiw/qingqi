...
<template>
  <div class="card mx-3 b-no">
    ...
    >
      <Row>
        <Col span="6">
          <FormItem label="申报期" prop="val1">
            <DatePicker
              type="month"
              :clearable="false"
              style="width: 100%"
              :value="formValidate.val1"
              @on-change="formValidate.val1 = $event"
            ></DatePicker>
          </FormItem>
        </Col>
        <Col span="6">
          <FormItem label="下拉" prop="val2">
            <Select v-model="formValidate.val2" filterable>
